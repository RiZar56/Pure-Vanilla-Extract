...
public class PureVanillaExtractItems {
    ...
    public static final Item CLUCKSHROOM_SPAWN_EGG = registerItem("cluckshroom_spawn_egg", new SpawnEggItem(PureVanillaExtractEntities.CLUCKSHROOM, 0xdbdbdb, 0xab1114, new FabricItemSettings()));
